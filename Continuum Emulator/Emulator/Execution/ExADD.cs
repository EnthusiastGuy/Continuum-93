...
namespace Continuum93.Emulator.Execution
{
    public static class ExADD
    {
        public static void Process(Computer computer)
        {
            ...
            switch (ldOp)
            {
                case Mnem.ADDSUB_r_n:   // ADD r, n
                    {
                        byte register = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte regValue = computer.MEMC.Fetch();
                        computer.CPU.REGS.AddTo8BitRegister(register, regValue);
                        return;
                    }
                case Mnem.ADDSUB_r_r:   // ADD r, r
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo8BitRegister(
                            reg1,
                            computer.CPU.REGS.Get8BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_r_InnnI:   // ADD r, (nnn)
                    {
                        byte register = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        uint address = computer.MEMC.Fetch24();
                        computer.CPU.REGS.AddTo8BitRegister(register, computer.MEMC.Get8bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB_r_IrrrI:   // ADD r, (rrr)
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo8BitRegister(
                ...
                case Mnem.ADDSUB_rr_n:   // ADD rr, n
                    {
                        byte register = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        ushort regValue = computer.MEMC.Fetch();
                        computer.CPU.REGS.AddTo16BitRegister(register, regValue);
                        return;
                    }
                case Mnem.ADDSUB16_rr_nn:   // ADD16 rr, nn
                    {
                        byte register = (byte)(computer.MEMC.Fetch() & 0b00011111);
                ...
                case Mnem.ADDSUB_rr_r:   // ADD rr, r
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo16BitRegister(reg1, computer.CPU.REGS.Get8BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rr_rr:   // ADD rr, rr
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo16BitRegister(reg1, computer.CPU.REGS.Get16BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rr_InnnI:   // ADD rr, (nnn) or ADD rr, 16(nnn)
                    {
                        byte register = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        uint address = computer.MEMC.Fetch24();

                        computer.CPU.REGS.AddTo16BitRegister(register, computer.MEMC.Get8bitFromRAM(address));
                ...
                case Mnem.ADDSUB16_rr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo16BitRegister(register, computer.MEMC.Get16bitFromRAM(address));

                        return;
                    }
                case Mnem.ADDSUB_rr_IrrrI:   // ADD rr, (rrr)
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo16BitRegister(
                            reg1,
                            computer.MEMC.Get8bitFromRAM(computer.CPU.REGS.Get24BitRegister(reg2)));
                        return;
                    }
                case Mnem.ADDSUB16_rr_IrrrI:    // ADD16 rr, (rrr)
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                ...
                case Mnem.ADDSUB_rrr_n:    // ADD rrr, n
                    {
                        byte reg = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo24BitRegister(reg, computer.MEMC.Fetch());

                        return;
                    }
                case Mnem.ADDSUB16_rrr_n:   // ADD16 rrr, nn
                    {
                        byte reg = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo24BitRegister(reg, computer.MEMC.Fetch16());

                        return;
                    }
                case Mnem.ADDSUB24_rrr_n:   // ADD24 rrr, nnn
                    {
                        byte reg = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo24BitRegister(reg, computer.MEMC.Fetch24());

                        return;
                    }
                case Mnem.ADDSUB_rrr_r:     // ADD rrr, r
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo24BitRegister(reg1, computer.CPU.REGS.Get8BitRegister(reg2));

                        return;
                    }
                case Mnem.ADDSUB_rrr_rr:     // ADD rrr, rr
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo24BitRegister(reg1, computer.CPU.REGS.Get16BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rrr_rrr:     // ADD rrr, rrr
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo24BitRegister(reg1, computer.CPU.REGS.Get24BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rrr_InnnI:    // ADD rrr, n or ADD16 rrr, nn or ADD 24 rrr, nnn
                    {
                        byte register = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        uint address = computer.MEMC.Fetch24();

                        computer.CPU.REGS.AddTo24BitRegister(register, computer.MEMC.Get8bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB16_rrr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo24BitRegister(register, computer.MEMC.Get16bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB24_rrr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo24BitRegister(register, computer.MEMC.Get24bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB_rrr_IrrrI:
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        computer.CPU.REGS.AddTo24BitRegister(
                            reg1,
                            computer.MEMC.Get8bitFromRAM(computer.CPU.REGS.Get24BitRegister(reg2)));
                        return;
                    }
                ...
                case Mnem.ADDSUB_rrrr_n:
                    {
                        computer.CPU.REGS.AddTo32BitRegister(
                ...
                case Mnem.ADDSUB_rrrr_r:     // ADD rrrr, r
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo32BitRegister(reg1, computer.CPU.REGS.Get8BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rrrr_rr:     // ADD rrrr, rr
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo32BitRegister(reg1, computer.CPU.REGS.Get16BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rrrr_rrr:     // ADD rrrr, rrr
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo32BitRegister(reg1, computer.CPU.REGS.Get24BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rrrr_rrrr:     // ADD rrrr, rrrr
                    {
                        byte reg1 = (byte)(computer.MEMC.Fetch() & 0b00011111);
                        byte reg2 = (byte)(computer.MEMC.Fetch() & 0b00011111);

                        computer.CPU.REGS.AddTo32BitRegister(reg1, computer.CPU.REGS.Get32BitRegister(reg2));
                        return;
                    }
                case Mnem.ADDSUB_rrrr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo32BitRegister(register, computer.MEMC.Get8bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB16_rrrr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo32BitRegister(register, computer.MEMC.Get16bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB24_rrrr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo32BitRegister(register, computer.MEMC.Get24bitFromRAM(address));
                        return;
                    }
                case Mnem.ADDSUB32_rrrr_InnnI:
                    {
                        ...
                        computer.CPU.REGS.AddTo32BitRegister(register, computer.MEMC.Get32bitFromRAM(address));
                        return;
                    }
                ...
                case Mnem.ADDSUB_InnnI_nnn:
                    {
                        ...
                        computer.MEMC.Set8bitToRAM(
                                target,
                                computer.CPU.REGS.Add8BitValues(
                ...
                case Mnem.ADDSUB16_InnnI_nnn:
                    {
                        ...
                        computer.MEMC.Set16bitToRAM(
                                target,
                                computer.CPU.REGS.Add16BitValues(
                ...
                case Mnem.ADDSUB24_InnnI_nnn:
                    {
                        ...
                        computer.MEMC.Set24bitToRAM(
                                target,
                                computer.CPU.REGS.Add24BitValues(
                ...
                case Mnem.ADDSUB32_InnnI_nnn:
                    {
                        ...
                        computer.MEMC.Set32bitToRAM(
                            target,
                            computer.CPU.REGS.Add32BitValues(
                ...
                case Mnem.ADDSUB_InnnI_r:
                    {
                        ...
                        computer.MEMC.Set8bitToRAM(
                            ...
                            computer.CPU.REGS.Add8BitValues(
                                computer.MEMC.Get8bitFromRAM(target),
                                computer.CPU.REGS.Get8BitRegister(regIndex)
                                )
                            );
                        return;
                    }
                ...
                case Mnem.ADDSUB_IrrrI_r:
                    {
                        ...
                        computer.MEMC.Set8bitToRAM(
                            target,
                            computer.CPU.REGS.Add8BitValues(memValue, regValue)
                            );
                        return;
                    }
                case Mnem.ADDSUB16_IrrrI_r:
                    {
                        ...
                        computer.MEMC.Set16bitToRAM(
                            target,
                            computer.CPU.REGS.Add16BitValues(memValue, regValue)
                            );
                        return;
                    }
                case Mnem.ADDSUB24_IrrrI_r:
                    {
                        ...
                        computer.MEMC.Set24bitToRAM(
                            target,
                            computer.CPU.REGS.Add24BitValues(memValue, regValue)
                            );
                        return;
                    }
                case Mnem.ADDSUB32_IrrrI_r:
                    {
                        ...
                        computer.MEMC.Set32bitToRAM(
                            target,
                            computer.CPU.REGS.Add32BitValues(memValue, regValue)
                            );
                        return;
                    }
                ...
                case Mnem.ADDSUB_fr_fr:
                    {
                        ...
                        computer.CPU.FREGS.SetRegister(fReg1,
                            computer.CPU.FREGS.AddFloatValues(fReg1Value, fReg2Value));
                ...
                case Mnem.ADDSUB_fr_nnn:
                    {
                        ...
                        computer.CPU.FREGS.SetRegister(fReg,
                            computer.CPU.FREGS.AddFloatValues(fRegValue, floatValue));
                ...
                case Mnem.ADDSUB_fr_r:
                    {
                        ...
                        computer.CPU.FREGS.SetRegister(fRegIndex,
                            computer.CPU.FREGS.AddFloatValues(fRegValue, regValue));
                ...
                case Mnem.ADDSUB_fr_InnnI:
                    {
                        ...
                        computer.CPU.FREGS.SetRegister(fReg,
                            computer.CPU.FREGS.AddFloatValues(fRegValue, adrFloatValue));
