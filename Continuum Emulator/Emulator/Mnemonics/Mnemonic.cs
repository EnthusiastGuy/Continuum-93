...
namespace Continuum93.Emulator.Mnemonics
{
    public class Mnem
    {
        ...
        public const byte LD = 1, LD16 = LD, LD24 = LD, LD32 = LD;
        public const byte ADD = 2, ADD16 = ADD, ADD24 = ADD, ADD32 = ADD;
        public const byte SUB = 3, SUB16 = SUB, SUB24 = SUB, SUB32 = SUB;
        ...
        // 3-6 bit identifier of the sub-operation
        public const byte LD_r_n = 0;
        public const byte LD_r_r = 1;
        public const byte LD_r_InnnI = 2;
        public const byte LD_r_IrrrI = 3;

        public const byte LD_rr_nn = 4;
        public const byte LD_rr_rr = 5;
        public const byte LD_rr_InnnI = 6;
        public const byte LD_rr_IrrrI = 7;

        public const byte LD_rrr_nnn = 8;
        public const byte LD_rrr_rrr = 9;
        public const byte LD_rrr_InnnI = 10;
        public const byte LD_rrr_IrrrI = 11;
        //public const byte LD_rrr_SP_ = 12;

        public const byte LD_rrrr_nnn = 13;
        public const byte LD_rrrr_rrrr = 14;
        public const byte LD_rrrr_InnnI = 15;
        public const byte LD_rrrr_IrrrI = 16;

        //public const byte LD_SP_nnn = 17;             // LD SPR, nnn or LD SPC, nnn
        //public const byte LD_SP_rrr = 18;             // LD SPR, rrr or LD SPC, rrr
        //public const byte LD_SP_IrrrI = 19;           // LD SPR, (rrr) or LD SPC, (rrr)

        public const byte LD_InnnI_nnn = 20;            // LD (nnn), n
        public const byte LD16_InnnI_nnn = 21;          // LD16 (nnn), nn
        public const byte LD24_InnnI_nnn = 22;          // LD24 (nnn), nnn
        public const byte LD32_InnnI_nnn = 23;          // LD32 (rrr), nnnn

        public const byte LD_InnnI_r = 24;
        public const byte LD_InnnI_rr = 25;
        public const byte LD_InnnI_rrr = 26;
        public const byte LD_InnnI_rrrr = 27;

        public const byte LD_IrrrI_nnn = 28;            // LD (rrr), n
        public const byte LD16_IrrrI_nnn = 29;          // LD16 (rrr), nn
        public const byte LD24_IrrrI_nnn = 30;          // LD24 (rrr), nnn
        public const byte LD32_IrrrI_nnn = 31;          // LD32 (rrr), nnnn

        public const byte LD_IrrrI_r = 32;
        public const byte LD_IrrrI_rr = 33;
        public const byte LD_IrrrI_rrr = 34;
        public const byte LD_IrrrI_rrrr = 35;

        // Floating point load

        public const byte LD_fr_fr = 36;
        public const byte LD_fr_r = 37;
        public const byte LD_fr_rr = 38;
        public const byte LD_fr_rrr = 39;
        public const byte LD_fr_rrrr = 40;

        public const byte LD_r_fr = 41;
        public const byte LD_rr_fr = 42;
        public const byte LD_rrr_fr = 43;
        public const byte LD_rrrr_fr = 44;

        public const byte LD_fr_IrrrI = 45;


        public const byte LD_IrrrI_fr = 46;

        public const byte LD_fr_nnn = 47;
        public const byte LD_fr_InnnI = 48;


        public const byte LD_InnnI_fr = 49;



        // ADD, SUB
        public const byte ADDSUB_r_n = 0;
        public const byte ADDSUB_r_r = 1;
        public const byte ADDSUB_r_InnnI = 2;
        public const byte ADDSUB_r_IrrrI = 3;

        public const byte ADDSUB_rr_n = 4;
        public const byte ADDSUB16_rr_nn = 5;
        public const byte ADDSUB_rr_r = 6;
        public const byte ADDSUB_rr_rr = 7;

        public const byte ADDSUB_rr_InnnI = 8;       // ADD rr, (nnn)
        public const byte ADDSUB16_rr_InnnI = 9;       // ADD16 rr, (nnn)
        public const byte ADDSUB_rr_IrrrI = 10;
        public const byte ADDSUB16_rr_IrrrI = 11;

        public const byte ADDSUB_rrr_n = 12;            // ADD rrr
        public const byte ADDSUB16_rrr_n = 13;            // ADD16 rrr, nn
        public const byte ADDSUB24_rrr_n = 14;            // ADD24 rrr, nnn
        public const byte ADDSUB_rrr_r = 15;
        public const byte ADDSUB_rrr_rr = 16;
        public const byte ADDSUB_rrr_rrr = 17;

        public const byte ADDSUB_rrr_InnnI = 18;       // ADD rrr, (nnn)
        public const byte ADDSUB16_rrr_InnnI = 19;       // ADD16 rrr, (nnn)
        public const byte ADDSUB24_rrr_InnnI = 20;       // ADD24 rrr, (nnn)

        public const byte ADDSUB_rrr_IrrrI = 21;
        public const byte ADDSUB16_rrr_IrrrI = 22;
        public const byte ADDSUB24_rrr_IrrrI = 23;

        public const byte ADDSUB_rrrr_n = 24;              // ADD rrrr
        public const byte ADDSUB16_rrrr_n = 25;            // ADD16 rrrr
        public const byte ADDSUB24_rrrr_n = 26;            // ADD24 rrrr, nnn
        public const byte ADDSUB32_rrrr_n = 27;            // ADD32 rrrr, nnnn

        public const byte ADDSUB_rrrr_r = 28;
        public const byte ADDSUB_rrrr_rr = 29;
        public const byte ADDSUB_rrrr_rrr = 30;
        public const byte ADDSUB_rrrr_rrrr = 31;

        public const byte ADDSUB_rrrr_InnnI = 32;       // ADD rrr
        public const byte ADDSUB16_rrrr_InnnI = 33;       // ADD16 rrr, (nnn)
        public const byte ADDSUB24_rrrr_InnnI = 34;       // ADD24 rrr, (nnn)
        public const byte ADDSUB32_rrrr_InnnI = 35;       // ADD24 rrr, (nnn)

        public const byte ADDSUB_rrrr_IrrrI = 36;
        public const byte ADDSUB16_rrrr_IrrrI = 37;
        public const byte ADDSUB24_rrrr_IrrrI = 38;
        public const byte ADDSUB32_rrrr_IrrrI = 39;

        public const byte ADDSUB_InnnI_nnn = 40;            // ADD (nnn), n
        public const byte ADDSUB16_InnnI_nnn = 41;            // ADD 16(nnn), n
        public const byte ADDSUB24_InnnI_nnn = 42;            // ADD 24(nnn), n
        public const byte ADDSUB32_InnnI_nnn = 43;            // ADD 32(nnn), n

        public const byte ADDSUB_InnnI_r = 44;              // ADD (nnn), r
        public const byte ADDSUB16_InnnI_r = 45;              // ADD16 (nnn), r
        public const byte ADDSUB24_InnnI_r = 46;              // ADD24 (nnn), r
        public const byte ADDSUB32_InnnI_r = 47;              // ADD32 (nnn), r


        public const byte ADDSUB16_InnnI_rr = 48;             // ADD16 (nnn), rr
        public const byte ADDSUB24_InnnI_rr = 49;             // ADD24 (nnn), rr
        public const byte ADDSUB32_InnnI_rr = 50;             // ADD32 (nnn), rr

        public const byte ADDSUB24_InnnI_rrr = 51;            // ADD24 (nnn), rrr
        public const byte ADDSUB32_InnnI_rrr = 52;            // ADD32 (nnn), rrr

        public const byte ADDSUB32_InnnI_rrrr = 53;            // ADD32 (nnn), rrr

        public const byte ADDSUB_IrrrI_nnn = 54;            // ADD (rrr), n
        public const byte ADDSUB16_IrrrI_nnn = 55;            // ADD16 (rrr), nn
        public const byte ADDSUB24_IrrrI_nnn = 56;            // ADD24 (rrr), nnn
        public const byte ADDSUB32_IrrrI_nnn = 57;            // ADD32 (rrr), nnnn

        public const byte ADDSUB_IrrrI_r = 58;              // ADD (rrr), r
        public const byte ADDSUB16_IrrrI_r = 59;              // ADD16 (rrr), r
        public const byte ADDSUB24_IrrrI_r = 60;              // ADD24 (rrr), r
        public const byte ADDSUB32_IrrrI_r = 61;              // ADD32 (rrr), r

        public const byte ADDSUB16_IrrrI_rr = 62;             // ADD16 (rrr), rr
        public const byte ADDSUB24_IrrrI_rr = 63;             // ADD24 (rrr), rr
        public const byte ADDSUB32_IrrrI_rr = 64;             // ADD32 (rrr), rr

        public const byte ADDSUB24_IrrrI_rrr = 65;            // ADD24 (rrr), rrr
        public const byte ADDSUB32_IrrrI_rrr = 66;            // ADD32 (rrr), rrr

        public const byte ADDSUB_IrrrI_rrrr = 67;           // ADD (rrr), rrrr

        // Floating point ADD

        public const byte ADDSUB_fr_fr = 68;           // ADD fr, fr
        public const byte ADDSUB_fr_nnn = 69;           // ADD fr, nnn

        public const byte ADDSUB_fr_r = 70;           // ADD fr, r
        public const byte ADDSUB_fr_rr = 71;           // ADD fr, rr
        public const byte ADDSUB_fr_rrr = 72;           // ADD fr, rrr
        public const byte ADDSUB_fr_rrrr = 73;           // ADD fr, rrrr

        public const byte ADDSUB_r_fr = 74;           // ADD r, fr
        public const byte ADDSUB_rr_fr = 75;           // ADD rr, fr
        public const byte ADDSUB_rrr_fr = 76;           // ADD rrr, fr
        public const byte ADDSUB_rrrr_fr = 77;           // ADD rrrr, fr

        public const byte ADDSUB_fr_InnnI = 78;
        public const byte ADDSUB_fr_IrrrI = 79;
        public const byte ADDSUB_InnnI_fr = 80;
        public const byte ADDSUB_IrrrI_fr = 81;

        public const byte ADDSUB_InnnI_InnnI = 82;            // ADD (nnn), (nnn)
        public const byte ADDSUB16_InnnI_InnnI = 83;            // ADD16 (nnn), (nnn)
        public const byte ADDSUB24_InnnI_InnnI = 84;            // ADD24 (nnn), (nnn)
        public const byte ADDSUB32_InnnI_InnnI = 85;            // ADD32 (nnn), (nnn)
