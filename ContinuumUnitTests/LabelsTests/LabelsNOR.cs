...
{
    public class LabelsNOR
    {
        [Fact]
        public void TestLabel_NOR()
        {
            Assembler cp = new();
            ...
            Assert.Equal(0b00001100, computer.MEMC.Get8bitFromRAM(dataAddress));
        ...
        public void TestLabel_NOR16()
        {
            ...
            Assert.Equal(0b0000110000001000, computer.MEMC.Get16bitFromRAM(dataAddress));
            Assert.Equal(0b11000110, computer.MEMC.Get8bitFromRAM(dataAddress + 2));
            Assert.Equal(0b01110000, computer.MEMC.Get8bitFromRAM(dataAddress + 3));
            Assert.Equal(0b00100100, computer.MEMC.Get8bitFromRAM(dataAddress + 4));
            TUtils.IncrementCountedTests("exec");
        ...
        public void TestLabel_NOR24()
        {
            ...
            cp.Build(@$"
                ...
                NOR24 (.Data), 0b111000101110001011100010
                BREAK
            ...
            Assert.Equal(0b000011000000100000011001,
        ...
        public void TestLabel_NOR32()
        {
            ...
            cp.Build(@$"
                ...
                NOR32 (.Data), 0b11100010111000101110001011100010
                BREAK
            ...
            Assert.Equal(0b00001100000010000001100100001101,
