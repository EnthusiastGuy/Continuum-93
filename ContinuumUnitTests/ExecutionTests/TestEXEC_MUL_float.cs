...
namespace ExecutionTests
{
    ...
    public class TestEXEC_MUL_float
    {
        [Fact]
        public void TestEXEC_MUL_fr_fr()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 16; j++)
                {
                    ...
                    cp.Build(
                        TUtils.GetFormattedAsm(
                            string.Format("MUL {0},{1}", TUtils.GetFloatRegisterString(i), TUtils.GetFloatRegisterString(j)),
                            "BREAK"
                        )
                    );
        ...
        [Fact]
        public void TestEXEC_MUL_fr_nnn()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                cp.Build(
                    TUtils.GetFormattedAsm(
                        string.Format("MUL {0},0.25", TUtils.GetFloatRegisterString(i)),
                        "BREAK"
                    )
                );
        ...
        [Fact]
        public void TestEXEC_MUL__fr_r_8bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL__fr_r_16bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL__fr_r_24bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL__fr_r_32bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_8bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_8bit_negative()
        {
            string shortLog = "";
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_16bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_16bit_negative()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_24bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_24bit_negative()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_32bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_r_fr_32bit_negative()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_fr_InnnI()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                cp.Build(
                    TUtils.GetFormattedAsm(
                        string.Format("MUL {0},(0x2000)", TUtils.GetFloatRegisterString(i)),
                        "BREAK"
                    )
                );
        ...
        [Fact]
        public void TestEXEC_MUL_fr_IrrrI()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_MUL_InnnI_fr()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                cp.Build(
                    TUtils.GetFormattedAsm(
                        string.Format("MUL (0x2000),{0}", TUtils.GetFloatRegisterString(i)),
                        "BREAK"
                    )
                );
        ...
        [Fact]
        public void TestEXEC_MUL_IrrrI_fr()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
