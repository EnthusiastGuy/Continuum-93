...
namespace ExecutionTests
{
    ...
    public class TestEXEC_SUB_float
    {
        [Fact]
        public void TestEXEC_SUB_fr_fr()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                string instructions = TUtils.GetFormattedAsm(
                        $"SUB {TUtils.GetFloatRegisterString(i)},{TUtils.GetFloatRegisterString(i)}",
                        "BREAK");

                cp.Build(instructions);
        ...
        [Fact]
        public void TestEXEC_SUB_fr_nnn()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                cp.Build(
                    TUtils.GetFormattedAsm(
                        string.Format("SUB {0},0.25", TUtils.GetFloatRegisterString(i)),
                        "BREAK"
                    )
                );
        ...
        [Fact]
        public void TestEXEC_SUB__fr_r_8bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB__fr_r_16bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB__fr_r_24bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB__fr_r_32bit()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_8bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_8bit_negative()
        {
            string shortLog = "";
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_16bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_16bit_negative()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_24bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_24bit_negative()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_32bit_positive()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_r_fr_32bit_negative()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_fr_InnnI()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                cp.Build(
                    TUtils.GetFormattedAsm(
                        string.Format("SUB {0},(0x2000)", TUtils.GetFloatRegisterString(i)),
                        "BREAK"
                    )
                );
        ...
        [Fact]
        public void TestEXEC_SUB_fr_IrrrI()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
        ...
        [Fact]
        public void TestEXEC_SUB_InnnI_fr()
        {
            for (byte i = 0; i < 16; i++)
            {
                Assembler cp = new();
                ...
                cp.Build(
                    TUtils.GetFormattedAsm(
                        string.Format("SUB (0x2000),{0}", TUtils.GetFloatRegisterString(i)),
                        "BREAK"
                    )
                );
        ...
        [Fact]
        public void TestEXEC_SUB_IrrrI_fr()
        {
            for (byte i = 0; i < 16; i++)
            {
                for (byte j = 0; j < 26; j++)
                {
                    ...
                    string instructions = TUtils.GetFormattedAsm(
                        $"SUB ({TUtils.Get24bitRegisterString(j)}),{TUtils.GetFloatRegisterString(i)}",
                        "BREAK"
                    );
                    ...
                    float expectedValue = floatRAMValue - floatRegValue;
                    float actualValue = computer.MEMC.GetFloatFromRAM(0x2000);
